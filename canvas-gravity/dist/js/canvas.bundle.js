...
function createBackground() {
  ...
  STATIC_OBJECTS_ARRAY.push(new Mount(0, topOfFloor, CANVAS.width * 1.15, CANVAS.height * .3, MOUNT_COLOR_1));

  STATIC_OBJECTS_ARRAY.push(new Mount(-(CANVAS.width * 1.2) % CANVAS.width, topOfFloor, CANVAS.width / 2 * 1.3, CANVAS.height * .5, MOUNT_COLOR_2));
  STATIC_OBJECTS_ARRAY.push(new Mount(CANVAS.width / 2 * .8, topOfFloor, CANVAS.width * 1.2, CANVAS.height * .5, MOUNT_COLOR_2));

  var thirdCrt = CANVAS.width / 3 * 1.1;
  STATIC_OBJECTS_ARRAY.push(new Mount(-3 * thirdCrt % CANVAS.width, topOfFloor, thirdCrt, CANVAS.height * .70, MOUNT_COLOR_3));
  STATIC_OBJECTS_ARRAY.push(new Mount(CANVAS.width / 3 * .7, topOfFloor, 2 * thirdCrt, CANVAS.height * .70, MOUNT_COLOR_3));
  STATIC_OBJECTS_ARRAY.push(new Mount(2 * CANVAS.width / 3 * .9, topOfFloor, 3 * thirdCrt, CANVAS.height * .70, MOUNT_COLOR_3));
...
function init() {
  ...
  createBackground();
  for (var i = 0; i < randomIntFromRange(2, 4); i++) {
    skyFall();
  }
}
